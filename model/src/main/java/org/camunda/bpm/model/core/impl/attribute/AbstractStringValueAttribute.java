 ...
 *
 */
public abstract class AbstractStringValueAttribute extends Attribute<String> {

  public AbstractStringValueAttribute(AbstractModelElement element) {
    super(element);
  }

  public AbstractStringValueAttribute(AbstractModelElement element, String namespaceUri) {

...
public class MultiInstanceLoopCharacteristicsImpl extends LoopCharacteristicsImpl implements
  ...
  protected static Attribute<MultiInstanceFlowConditionType> behaviorTypeAttribute;
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder
        .defineType(MultiInstanceLoopCharacteristics.class,
            BPMN_ELEMENT_MULTI_INSTANCE_LOOP_CHARACTERISTICS).namespaceUri(BPMN20_NS)
    ...
    loopDataInputRefChild = sequenceBuilder.element(LoopDataInputRef.class)
        .qNameElementReference(DataInput.class).build();

    loopDataOutputRefChild = sequenceBuilder.element(LoopDataOutputRef.class)
        .qNameElementReference(DataOutput.class).build();
    ...
    complexBehaviorDefinitionCollection = sequenceBuilder.elementCollection(
        ComplexBehaviorDefinition.class).build();
    ...
    behaviorTypeAttribute = typeBuilder
        .enumAttribute(BPMN_ELEMENT_BEHAVIOR, MultiInstanceFlowConditionType.class)
        .defaultValue(MultiInstanceFlowConditionType.All).build();

    oneBehaviorEventRefAttribute = typeBuilder.stringAttribute(BPMN_ELEMENT_ONE_BEHAVIOR_EVENT_REF)
        .qNameAttributeReference(EventDefinition.class).build();
  ...
  public MultiInstanceFlowConditionType getBehavior() {
    return behaviorTypeAttribute.getValue(this);
  }

  public void setBehavior(MultiInstanceFlowConditionType behavior) {
    behaviorTypeAttribute.setValue(this, behavior);
  }

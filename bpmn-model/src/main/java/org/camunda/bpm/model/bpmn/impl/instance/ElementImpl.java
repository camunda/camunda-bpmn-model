...
/**
 * A basic element with an ID to reference to
 *
 * @author Sebastian Menski
 */
public abstract class ElementImpl extends ModelElementInstanceImpl implements Element {

  private static Attribute<String> idAttribute;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(Element.class, null)
